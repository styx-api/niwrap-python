...
def label_resample_cargs(
    ...
    cargs.extend([
        ...
        *label_resample_area_surfs_cargs(params.get("area-surfs", None), execution),
        *label_resample_area_metrics_cargs(params.get("area-metrics", None), execution),
        "-current-roi",
        execution.input_file(params.get("roi-metric", None)),
        *label_resample_valid_roi_out_cargs(params.get("valid-roi-out", None), execution),
        "-largest",
        "-bypass-sphere-check"
    ])
