...
def cifti_palette_cargs(
    ...
    cargs.extend([
        ...
        *cifti_palette_pos_percent_cargs(params.get("pos-percent", None), execution),
        *cifti_palette_neg_percent_cargs(params.get("neg-percent", None), execution),
        *cifti_palette_pos_user_cargs(params.get("pos-user", None), execution),
        *cifti_palette_neg_user_cargs(params.get("neg-user", None), execution),
        "-interpolate",
        ...
        *cifti_palette_thresholding_cargs(params.get("thresholding", None), execution),
        "-inversion",
        params.get("type", None),
        "-normalization",
        params.get("type", None)
