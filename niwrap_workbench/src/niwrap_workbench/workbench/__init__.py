...
Connectome Workbench is an open-source visualization and discovery tool
developed for the Human Connectome Project (HCP) at Washington University in St.
Louis. It includes wb_view, a GUI-based visualization platform for exploring
brain imaging data on cortical surfaces and volumes, and wb_command, a
command-line program for performing algorithmic tasks using volume, surface, and
grayordinate (CIFTI) data. wb_command is essential for running HCP minimal
processing pipelines.

Authors: Daniel S. Marcus, John Harwell, Timothy S. Coalson, Matthew F. Glasser,
David C. Van Essen

Literature:
Marcus, D. S., Harwell, J., Olsen, T., Hodge, M., Glasser, M. F., Prior, F., ...
& Van Essen, D. C. (2011). Informatics and Data Mining Tools and Strategies for
...
Andersson, J. L., ... & Van Essen, D. C. (2013). The Minimal Preprocessing
