...
_PlugoutTtParamsDictNoTag = typing.TypedDict('_PlugoutTtParamsDictNoTag', {
...
PlugoutTtParamsDictTagged = typing.TypedDict('PlugoutTtParamsDictTagged', {
...
PlugoutTtParamsDict = _PlugoutTtParamsDictNoTag | PlugoutTtParamsDictTagged
...
def plugout_tt_validate(
    params: typing.Any,
) -> None:
    """
    Validate parameters. Throws an error if `params` is not a valid
    `PlugoutTtParamsDict` object.
    ...
    if params.get("ijk_option", False) is None:
        raise StyxValidationError("`ijk_option` must not be None")
    if not isinstance(params["ijk_option"], bool):
        raise StyxValidationError(f'`ijk_option` has the wrong type: Received `{type(params.get("ijk_option", False))}` expected `bool`')
