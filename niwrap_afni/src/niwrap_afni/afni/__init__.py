...
AFNI (Analysis of Functional NeuroImages) is a suite of programs for the
analysis and visualization of multiple MRI modalities: anatomical, functional
MRI (FMRI), and diffusion weighted (DW) data. Developed and maintained at the
National Institute of Mental Health (NIMH), AFNI provides a comprehensive
environment for processing, analyzing, and visualizing neuroimaging data,
including real-time FMRI capabilities. It is freely available as open source
software for research purposes.

Authors: Robert W. Cox, Ziad S. Saad, Richard C. Reynolds, Daniel R. Glen, Paul
A. Taylor, Gang Chen
...
Cox, R. W. (2012). AFNI: What a Long Strange Trip It's Been. NeuroImage, 62(2),
