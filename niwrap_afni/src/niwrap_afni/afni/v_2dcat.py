...
def v_2dcat_validate(
    ...
    if params.get("res_in", None) is not None:
        ...
        if len(params["res_in"]) != 2:
            raise StyxValidationError("Parameter `res_in` must contain exactly 2 elements")
    ...
    if params.get("respad_in", None) is not None:
        ...
        if len(params["respad_in"]) != 2:
            raise StyxValidationError("Parameter `respad_in` must contain exactly 2 elements")
    ...
    if params.get("crop", None) is not None:
        ...
        if len(params["crop"]) != 4:
            raise StyxValidationError("Parameter `crop` must contain exactly 4 elements")
    ...
    if params.get("matrix", None) is not None:
        ...
        if len(params["matrix"]) != 2:
            raise StyxValidationError("Parameter `matrix` must contain exactly 2 elements")
    ...
    if params.get("gap_col", None) is not None:
        ...
        if len(params["gap_col"]) != 3:
            raise StyxValidationError("Parameter `gap_col` must contain exactly 3 elements")
