...
_MorphOnlySubjectLhParamsDictNoTag = typing.TypedDict('_MorphOnlySubjectLhParamsDictNoTag', {
    "subject_dir": str,
})
...
MorphOnlySubjectLhParamsDict = _MorphOnlySubjectLhParamsDictNoTag | MorphOnlySubjectLhParamsDictTagged
