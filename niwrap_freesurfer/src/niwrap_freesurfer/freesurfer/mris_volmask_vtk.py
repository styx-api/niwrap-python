...
MrisVolmaskVtkParamsDictTagged = typing.TypedDict('MrisVolmaskVtkParamsDictTagged', {
...
def mris_volmask_vtk_validate(
    params: typing.Any,
) -> None:
    """
    Validate parameters. Throws an error if `params` is not a valid
    `MrisVolmaskVtkParamsDict` object.
    ...
    if not isinstance(params["io_param"], str):
        raise StyxValidationError(f'`io_param` has the wrong type: Received `{type(params.get("io_param", None))}` expected `str`')
