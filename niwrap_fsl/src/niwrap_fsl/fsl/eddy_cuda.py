...
_EddyCudaParamsDictNoTag = typing.TypedDict('_EddyCudaParamsDictNoTag', {
    "imain": InputPathType,
    "mask": InputPathType,
    "index": InputPathType,
    "acqp": InputPathType,
...
EddyCudaParamsDictTagged = typing.TypedDict('EddyCudaParamsDictTagged', {
...
EddyCudaParamsDict = _EddyCudaParamsDictNoTag | EddyCudaParamsDictTagged


class EddyCudaOutputs(typing.NamedTuple):
    """
...
def eddy_cuda_validate(
    params: typing.Any,
) -> None:
    """
    Validate parameters. Throws an error if `params` is not a valid
    `EddyCudaParamsDict` object.
...
def eddy_cuda_execute(
    ...
    Returns:
        NamedTuple of outputs (described in `EddyCudaOutputs`).
    """
    eddy_cuda_validate(params)
    runner = runner or get_global_runner()
    execution = runner.start_execution(EDDY_CUDA_METADATA)
    params = execution.params(params)
    cargs = eddy_cuda_cargs(params, execution)
    ret = eddy_cuda_outputs(params, execution)
    execution.run(cargs)
    return ret
