...
MRtrix3 is a fast, flexible, and open software framework for medical image
processing and visualisation, with a particular focus on diffusion MRI analysis.
It provides tools for constrained spherical deconvolution,
anatomically-constrained tractography, fixel-based analysis, and next-generation
group-level analyses. It is freely available under the Mozilla Public License
v2.0.

Authors: J-Donald Tournier, Robert E. Smith, David Raffelt, Thijs Dhollander,
Alan Connelly

Literature: Tournier, J.-D., Smith, R. E., Raffelt, D., Tabbara, R., Dhollander,
T., Pietsch, M., Christiaens, D., Jeurissen, B., Yeh, C.-H., & Connelly, A.
