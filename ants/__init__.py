...
from .ants_registration_sy_n_quick_sh import *
from .ants_registration_sy_n_sh import *
from .ants_slice_regularized_registration import *
from .ants_transform_info import *
from .ants_use_deformation_field_to_get_affine_transform import *
from .ants_use_landmark_images_to_get_affine_transform import *
from .ants_use_landmark_images_to_get_b_spline_displacement_field import *
from .atropos import *
...
def execute(params: dict[str, typing.Any], runner: Runner | None = None) -> typing.Any:
    ...
    _dispatch: dict[str, typing.Callable[[typing.Any, Runner | None], typing.Any]] = {
        ...
        "ants/ANTSIntegrateVectorField": ants_integrate_vector_field_execute,
        ...
        "ants/ANTSJacobian": ants_jacobian_execute,
        ...
        "ants/antsRegistrationSyNQuick.sh": ants_registration_sy_n_quick_sh_execute,
        ...
        "ants/ANTSUseDeformationFieldToGetAffineTransform": ants_use_deformation_field_to_get_affine_transform_execute,
        "ants/ANTSUseLandmarkImagesToGetAffineTransform": ants_use_landmark_images_to_get_affine_transform_execute,
        "ants/ANTSUseLandmarkImagesToGetBSplineDisplacementField": ants_use_landmark_images_to_get_b_spline_displacement_field_execute,
        ...
        "ants/CreateDTICohort": create_dti_cohort_execute,
